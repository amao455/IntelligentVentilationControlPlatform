...
export const secondaryMenuMap: Record<ModuleKey, SecondaryMenuItem[]> = {
  ...
  monitor: [
    ...
    {
      key: "monitor-gas-realtime",
      title: "气体实时监测",
      path: "/monitor/gas-realtime",
    },
    {
    ...
    },
    {
      ...
      title: "重点区域实时监控",
      path: "/monitor/key-area",
    },
    {
      key: "monitor-device-status",
      title: "关键设备工况监测",
  ...
  twin: [
    ...
    {
      key: "twin-realtime-mapping",
      title: "三维工况实时映射",
      path: "/twin/realtime-mapping",
      variant: "twin",
    },
    {
      key: "twin-airflow-simulation",
      title: "风流孪生与动态仿真",
      path: "/twin/airflow-simulation",
      variant: "twin",
    },
    {
      key: "twin-disaster-evolution",
      title: "灾变演化三维推演",
      path: "/twin/disaster-evolution",
      variant: "twin",
    },
  ],
  analysis: [
    {
      key: "analysis-natural-air-distribution",
      title: "实时分风解算",
      path: "/analysis/natural-air-distribution",
      variant: "analysis",
    },
    {
      key: "analysis-demand-air-distribution",
      title: "按需分风解算",
      path: "/analysis/demand-air-distribution",
      variant: "analysis",
    },
    {
      key: "analysis-network-solving",
      title: "通风网络实时解算",
      path: "/analysis/network-solving",
      variant: "analysis",
    },
    {
    ...
    {
      key: "analysis-demand-resistance",
      title: "需风匹配与阻力风量分析",
      path: "/analysis/demand-resistance",
      variant: "analysis",
    },
    {
  ...
  decision: [
    {
      key: "decision-target-config",
      title: "调控目标配置",
      path: "/decision/target-config",
      variant: "decision",
    },
    {
      key: "decision-scheme-generate",
      title: "调控方案生成",
      path: "/decision/scheme-generate",
      variant: "decision",
    },
    {
      key: "decision-scheme-compare",
      title: "调控方案比选",
      path: "/decision/scheme-compare",
      variant: "decision",
    },
    {
      key: "decision-safety-check",
      title: "安全校核分析",
      path: "/decision/safety-check",
      variant: "decision",
    },
    {
      key: "decision-strategy-recommend",
      title: "最优策略推荐",
      path: "/decision/strategy-recommend",
      variant: "decision",
    },
    {
      key: "decision-effect-evaluation",
      title: "执行效果评估",
      path: "/decision/effect-evaluation",
      variant: "decision",
    },
  ],
  remote: [
    ...
    {
      key: "remote-local-fan-control",
      title: "局部风机控制",
      path: "/remote/local-fan-control",
      variant: "remote",
    },
    {
      key: "remote-door-control",
      title: "风门控制",
      path: "/remote/door-control",
      variant: "remote",
    },
    {
      key: "remote-window-control",
      title: "风窗控制",
      path: "/remote/window-control",
      variant: "remote",
    },
    {
    ...
    {
      key: "remote-execution-monitor",
      title: "执行状态监控",
      path: "/remote/execution-monitor",
      variant: "remote",
    },
  ],
  emergency: [
    ...
    {
      key: "emergency-air-control",
      title: "应急控风辅助决策",
      path: "/emergency/air-control",
      variant: "emergency",
    },
    {
      key: "emergency-execution-tracking",
      title: "应急执行过程跟踪",
      path: "/emergency/execution-tracking",
      variant: "emergency",
    },
  ],
};
...
export const pageMetaByPath = new Map(
  allPages.map((item) => [item.path, item]),
);
...
export function resolveModuleByPath(pathname: string): ModuleKey {
  ...
  const matched = (
    Object.entries(modulePathPrefix) as Array<[ModuleKey, string]>
